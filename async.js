// ? Async functions are a way to work with asynchronous oe in a more synchronous way. They are built on top of promises and are suntactic sugar for promises.
...
const pizzaPromise = () => {
    return new Promise((resolve, reject) => {
        ...
        if(order) {
            ...
            setTimeout(()=> { // setTimeout is used to simulate a delay
                reject("After 5 seconds, Pizza is not De;ivered!");
            },5000);
        }
    });
};
